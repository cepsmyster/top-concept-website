...
export const projects = [
  ...
  { slug: "al-manara-center", text: "A commercial interior: a boardroom with a long dark table, set behind glass partitions that keep it open to the space around it.", title: "Al Manara Center", label: "Commercial", cat: "interior-design", type: "interior", img: "p-al-manara-center", alt: "Boardroom interior with a long dark table and glass partitions" },
  { slug: "nshama", text: "Residential blocks with shops along the street, balconies on every floor and a palm-lined pool courtyard between the buildings.", title: "Nshama", label: "Residential", cat: "community", type: "architecture", img: "p-nshama", alt: "Nshama residential blocks with shops at street level, seen from the road", gallery: [
    { img: "p-nshama-2", cap: "The pool courtyard between the blocks, lined with palms" },
    { img: "p-nshama-3", cap: "The taller block, with glazed balconies up its full height" },
    { img: "p-nshama-4", cap: "Two blocks stepping up from a street of shops" },
    { img: "p-nshama-5", cap: "The corner block, its balconies curving round the corner" },
    { img: "p-nshama-6", cap: "Shopfronts under a dark podium along the street" },
    { img: "p-nshama-7", cap: "The development and its streets from above" },
    { img: "p-nshama-8", cap: "The street corner, with curved balconies above the shops" },
    { img: "p-nshama-9", cap: "A ground-floor terrace facing the pool" },
    { img: "p-nshama-10", cap: "Balconies stacked up the façade" },
  ], featured: true },
  ...
  { slug: "rox-showroom", text: "A showroom fit-out designed around the Rox brand and the way people move through the space, starting at the reception desk.", title: "Rox Showroom", label: "Commercial Interior", cat: "interior-design", type: "interior", img: "p-rox-reception", alt: "Rox showroom reception desk", gallery: [
    ...
    { img: "p-rox-showroom-4", cap: "A sports car and seating by the glass front" },
  ...
  { slug: "high-end-villa", text: "A two-storey contemporary villa designed for light, privacy and a strong connection to its setting.", title: "High-end villa", label: "Villas", cat: "villas", type: "architecture", img: "p-high-end-villa", alt: "Two-storey contemporary villa glowing at sunset" },
  { slug: "classical-villa", title: "Classical high-end villa", label: "Villas", cat: "villas", type: "architecture", img: "p-classical-villa", alt: "Classical white villa with a colonnaded entrance and a reflecting pool at sunset", text: "A private estate in Sheikha Ohood: the main villa with its formal gardens, plus a majlis, a mosque and a services building.", gallery: [
    ...
    { img: "p-classical-villa-4", cap: "The estate and its formal gardens from above" },
    { img: "p-classical-villa-5", cap: "The colonnaded porch at the corner of the villa" },
    { img: "p-classical-villa-6", cap: "The entrance portico and front steps" },
    { img: "p-classical-villa-7", cap: "The majlis, behind a circular fountain garden" },
    { img: "p-classical-villa-8", cap: "The mosque, with its dome and minaret" },
    { img: "p-classical-villa-9", cap: "The services building" },
    { img: "p-classical-villa-10", cap: "Key plan of the estate" },
    { img: "p-classical-villa-11", cap: "Floor plan of the main villa" },
    { img: "p-classical-villa-12", cap: "Majlis elevations" },
    { img: "p-classical-villa-13", cap: "Mosque elevation" },
  ], featured: true },
  ...
  { slug: "retail-park", title: "Retail Park", label: "Retail", cat: "retail", type: "architecture", img: "rp-02", alt: "Aerial view of the retail park with its market court and pavilion beside the desert", gallery: [
    { img: "rp-01", cap: "The Retail Park sign and a shaded forecourt welcome visitors in from the road." },
    { img: "rp-03", cap: "Shopfronts face a planted car park, with a cycle track along the front." },
    { img: "rp-04", cap: "White shade sails cover a brick-paved court of market stalls." },
    { img: "rp-05", cap: "A perforated brick screen wraps the pavilion and keeps it cool by day." },
    { img: "rp-06", cap: "Rows of trees shade a plaza of terraces and seating." },
    { img: "rp-07", cap: "Food pods line the promenade, with seating in the open air." },
  ...
  { slug: "minsk-villa", text: "A villa interior in Minsk, Belarus, finished in soft neutrals: an open living room, kitchen and dining space under linear lights, with dark timber shelving and a double-sided fire.", title: "Minsk Villa", label: "Interior Design", cat: "interior-design", type: "interior", img: "p-minsk-villa", alt: "Open living room of the Minsk Villa with cream sofas and timber floors", gallery: [
    ...
    { img: "p-minsk-villa-5", cap: "The kitchen, with a marble island and bar stools" },
    { img: "p-minsk-villa-6", cap: "The entrance hall, with a round table under the lights" },
    { img: "p-minsk-villa-7", cap: "Timber shelving and the double-sided fire" },
    { img: "p-minsk-villa-8", cap: "A black sideboard below a framed ink painting" },
  ...
  { slug: "classical-interior", text: "A classical living and dining room in London: deep green walls, white panelling, crystal chandeliers and a marble floor with a chequered inlay.", title: "Classical interior", label: "Interior Design", cat: "interior-design", type: "interior", img: "p-classical-interior", alt: "Classical living room with green walls, crystal chandelier and white sofas", gallery: [
    ...
    { img: "p-classical-interior-5", cap: "The dining room, framed by green curtains" },
    { img: "p-classical-interior-6", cap: "A chequered marble inlay leads to the dining table" },
    { img: "p-classical-interior-7", cap: "Lit shelving and a bench beside the entrance" },
    { img: "p-classical-interior-8", cap: "The dining table under a crystal chandelier" },
  ] },
